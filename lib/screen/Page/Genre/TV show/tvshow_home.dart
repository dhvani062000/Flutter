...
import 'package:task/screen/Page/Genre/TV%20show/genre_tvshow.dart';

class TvShowHomeScreen extends StatefulWidget {
  const TvShowHomeScreen({super.key});

  @override
  State<TvShowHomeScreen> createState() => _TvShowHomeScreenState();
}

class _TvShowHomeScreenState extends State<TvShowHomeScreen> {
  ...
  Widget _buildGenreCard(Map<String, dynamic> genre) {
    return GestureDetector(
      onTap: () {
        Get.to(() => GenreTvShowScreen(genreName: genre["name"]));
      },
      child: Container(
